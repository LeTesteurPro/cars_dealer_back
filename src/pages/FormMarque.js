...
function FormMarque() {
  ...
  const handleSubmit = (e) => {
      ...
      axios.post('https://carsdealerwebservice-production.up.railway.app/insertMarque', { nom })
          .then(response => {
  ...
  useEffect(() => {
    axios.get('https://carsdealerwebservice-production.up.railway.app/listMarque')
      .then(response => {
